  ...
  return (
    <>
      ...
      <InfoPage eyebrow="EDITORIAL POLICY" title="Evidence first. Limits made visible." intro="These standards govern how AI New Canada chooses, produces, labels and corrects editorial work.">
        ...
        <section><h2>Search-quality review</h2><p>Publishing a page and recommending it to search engines are separate decisions. Evidence-audited guides must have at least three directly relevant source links, a specific reader question, clear limits and an original practical contribution. As of August 14, 2026, 101 articles meet that standard and appear in the XML sitemap. Another 110 legacy briefings remain available to readers but are clearly labelled for editorial review, marked noindex and excluded from search discovery until their claims and direct primary sources are individually verified. We do not create near-duplicate query variations or change dates merely to look fresh.</p></section>
