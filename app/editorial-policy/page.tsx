  ...
  return (
    <>
      ...
      <InfoPage eyebrow="EDITORIAL POLICY" title="Evidence first. Limits made visible." intro="These standards govern how AI New Canada chooses, produces, labels and corrects editorial work.">
        <section><h2>Scope and purpose</h2><p>AI New Canada focuses on Canadian AI policy and practical ways to use and check AI. Our job is to help readers distinguish durable evidence from launch-day claims and apply what they learn responsibly.</p></section>
        ...
        <section><h2>The reader promise</h2><p>A headline, description and opening must agree about the question being answered. The opening should deliver the useful distinction or action promptly, without hiding it behind publication history, keyword-heavy scene-setting or an exaggerated claim. Each article must also contribute something specific: a worked example, decision framework, source comparison, limitation analysis or Canadian application that a generic summary would not provide.</p></section>
        <section><h2>Source roles and limits</h2><p>Every public article shows the domain, label and editorial note for each cited source. The note states what the source contributes and, where necessary, what it cannot establish. A company document can establish what the company announced; it does not become independent proof of performance. A policy proposal can establish what is being considered; it does not become enacted law.</p></section>
