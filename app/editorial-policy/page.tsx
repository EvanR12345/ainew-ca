  ...
  return (
    <>
      ...
      <InfoPage eyebrow="EDITORIAL POLICY" title="Evidence first. Limits made visible." intro="These standards govern how AI New Canada chooses, produces, labels and corrects editorial work.">
        ...
        <section><h2>Search-quality review</h2><p>Publishing a page and recommending it to search engines are separate decisions. Evidence-audited guides must have at least three directly relevant source links, a specific reader question, clear limits and an original practical contribution. On August 13, 2026, the original 111-article launch collection completed a substantial second editorial review: every article was expanded, re-sourced, connected to the evidence-led guide collection and returned to the XML sitemap. Any future page that has not completed this review remains marked noindex and excluded from search discovery. We do not create near-duplicate query variations or change dates merely to look fresh.</p></section>
