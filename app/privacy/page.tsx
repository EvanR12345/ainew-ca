...
export default function PrivacyPage() {
  return (
    <InfoPage eyebrow="LEGAL" title="Privacy policy" intro="How AI New Canada handles reader information. Last updated September 8, 2026.">
