...
export default function PrivacyPage() {
  return (
    <InfoPage eyebrow="LEGAL" title="Privacy policy" intro="A plain-language outline of how AI New handles reader information. Last updated August 10, 2026.">
      ...
      <section><h2>Analytics and advertising</h2><p>Advertising services may process device information, approximate location, pages viewed and interactions through cookies or similar technologies. Clearly labelled sponsored links open an external advertiser only after you choose to click; the advertising provider may then apply its own cookies and privacy terms. Consent controls will be added where required for non-essential tracking.</p></section>
      ...
      <section><h2>Reading recommendations</h2><p>The site stores time spent per story on this device so it can stop recommending an article after five minutes of reading. This reading history stays in your browser and is not transmitted to AI New Canada.</p></section>
