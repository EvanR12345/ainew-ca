    ...
    <div>
      ...
      <main className="shell authorPage" id="content">
        <StructuredData data={{
          ...
          dateModified: "2026-09-09T05:18:04Z",
          mainEntity: {
            "@type": "Organization",
            "@id": AUTHOR_ID,
            name: "AI New Desk",
        ...
        <header className="authorHeader">
          ...
          <p>AI New Desk is the publication byline for AI New Canada. It identifies a documented editorial process, not a fictional person or a claim of first-hand reporting.</p>
        </header>
