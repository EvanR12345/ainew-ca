...
export const articles: Article[] = [
  ...
  },
  {
    ...
    "disclaimer": "This evidence-led explainer uses the linked primary sources and original AI New analysis. It is educational, not legal, medical, financial or procurement advice; verify current requirements with qualified professionals.",
    "evidenceStatus": "verified",
    "originalityStatus": "individually-reviewed",
    "searchEligible": true,
    "sections": [
  ...
  },
  {
    ...
    "modifiedAt": "2026-09-09T05:18:04Z",
    "updateNote": "Narrowed the title to reflect a system-design guide, not a tested implementation tutorial.",
    "sources": [
      {
