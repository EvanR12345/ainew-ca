...
export const topicHubs: TopicHub[] = [
  {
    ...
    articleSlugs: [
      ...
      "canada-ai-for-all-national-strategy",
      "canadian-ai-safety-institute-guide",
      "canada-sovereign-ai-compute-explained",
      "federal-government-generative-ai-guide",
      "quebec-privacy-law-ai-systems",
      "ontario-public-sector-ai-procurement",
      "canada-ai-privacy-consent",
      "canada-aida-lessons-ai-law",
      "ai-election-integrity-canada",
      "ai-copyright-canada",
      "public-sector-ai-procurement-policy",
    ],
  },
  {
    slug: "using-ai",
