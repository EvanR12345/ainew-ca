  ...
  return (
    <>
      ...
      <InfoPage eyebrow="ABOUT AI NEW" title="AI is noisy. We make it useful." intro="AI New Canada is an independent digital publication built to explain Canadian AI policy, practical AI use, evaluation methods and the evidence behind fast-moving technology claims.">
        <section><h2>Who is responsible</h2><p>AI New Canada is an owner-operated publication. <Link href="/authors/ai-new-desk/">AI New Desk</Link> is its publication byline, not a staffed newsroom. The site does not publish the owner’s individual name or professional credentials. No article claims an independent expert review, interview or first-hand field study unless that work is documented in the article.</p><p>The publisher is responsible for publication and corrections. Send questions to <a href="mailto:newsroom@ainew.ca">newsroom@ainew.ca</a> with the article URL and disputed claim. Material corrections appear on the article and in the <Link href="/corrections-policy/">public correction record</Link>.</p></section>
        ...
        <section><h2>Ownership, funding and advertising</h2><p>The site is owner-operated and is seeking advertising eligibility. A static AdSense seller declaration and ownership tag are present, but the current site displays no ads and loads no advertising scripts. A sponsorship, affiliate relationship, supplied access or other material financial interest must be disclosed beside relevant coverage; no vendor outcome in the published exercises is presented as a paid test.</p></section>
